  ...
  return (
    <header className="bg-[url(/header.jpg)] bg-cover bg-center">
      <div className="container mx-auto py-12 flex flex-col justify-between min-h-[660px]">
        ...
        <div>
          <h2 className="text-white text-center text-3xl font-bold md:text-4xl md:text-right lg:text-5xl">
            Tu casa en el bosque
          </h2>
          <p className="text-white text-center md:text-xl md:text-right">
